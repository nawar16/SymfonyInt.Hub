...
To keep the core clean, I use dedicated integration modules to fetch external data and normalize it into DTOs. Business logic stays independent of the framework, while Doctrine ORM handles the persistence layer.
